...
last_modified: {
type: "/type/datetime",
value: "2025-12-15T09:37:45.661490"
}
}

$(document).ready(function() {
$("#Title").html(jsontext.title),
$("#PublishedBy").html("<strong>Published By: </strong>" + jsontext.publishers),
$("#Contributuions").html("<strong>Contributions: </strong>" + jsontext.contributions),
$("#PublishedDate").html("<strong>Published Date: </strong>" + jsontext.publish_date),
$("#Pages").html("<strong>Number of Pages: </strong>" + jsontext.number_of_pages)
